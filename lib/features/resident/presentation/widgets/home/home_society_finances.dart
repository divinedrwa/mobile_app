...
class HomeSocietyFinances extends StatelessWidget {
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                    child: ShimmerBox(
                        height: 52, borderRadius: DesignRadius.lg)),
  ...
  Widget _buildContent(BuildContext context, ResidentDashboardModel d) {
    ...
    final healthLabel = _healthLabel(fund.collectionRate, fund.societyFund);
    final healthColor = _healthColor(fund.collectionRate, fund.societyFund);
    final healthEmoji = _healthEmoji(fund.collectionRate, fund.societyFund);
