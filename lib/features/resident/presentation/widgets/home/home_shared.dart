...
const double kHomeQuickActionIconBoxHeight = 48;
const double kHomeQuickActionRowGap = 5;
const double kHomeQuickActionIconSize = 21;
const double kHomeQuickActionLabelSize = 10;
