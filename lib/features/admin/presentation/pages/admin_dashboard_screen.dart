      ...
      children: [
        _qaSection(
          ...
          items: [
            ...
            _QA(Icons.calendar_month_outlined, 'Billing Cycles',
                ActionColors.success, '/resident/admin-billing-cycles'),
            _QA(Icons.payment_outlined, 'Payment Methods', ActionColors.info,
        ...
        _qaSection(
          ...
          items: [
            ...
            _QA(Icons.manage_accounts_outlined, 'Users & Roles', ActionColors.info,
                '/resident/admin-roles'),
            _QA(Icons.groups_outlined, 'Visitors', ActionColors.accent,
        ...
        _qaSection(
          ...
          items: [
            ...
            _QA(Icons.view_carousel_outlined, 'Banners', ActionColors.brand,
